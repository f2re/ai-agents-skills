...
Use this skill for Docomator-like products and document-centric primary surfaces. Combine it with `workflow-and-progressive-disclosure`, `states-errors-and-recovery`, `dense-controls-and-selection` and the more focused document skills only when those concerns are present.
